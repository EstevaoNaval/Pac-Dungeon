...
# Screen
SCREEN_WIDTH, SCREEN_HEIGHT = 610, 670 # 16px X 28 tiles, 16px X 36 tiles + 16 X 4 tiles para placar
MAZE_WIDTH, MAZE_HEIGHT = SCREEN_WIDTH - TOP_BOTTOM_BUFFER, SCREEN_HEIGHT - TOP_BOTTOM_BUFFER
